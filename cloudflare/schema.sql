...
CREATE TABLE photos (
  ...
  lab_id INTEGER,
  frame_background_color TEXT,
  frame_gap_px INTEGER NOT NULL DEFAULT 0,
  frame_border_width_px INTEGER NOT NULL DEFAULT 0,
  frame_border_color TEXT,
  frame_image_position TEXT NOT NULL DEFAULT 'center center',
